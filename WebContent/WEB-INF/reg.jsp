		...
		<div class="clearfix" id="content">
			<div class="section">
				...
				<div class="sec_content">          
					<h2 class="text">注册会员账号 <span class="direct_login text">已经有账号? <a href="#" title="登录">请直接登录</a></span></h2>
					  <div class="reg-box">
						  <p>
							<label for="nickname_reg">用户名：</label>
							<input type="text" maxlength="12" class="txt_input r3px" title="请输入用户名"/>
						  </p>
						  <p>
							<label for="password_reg">密码：</label>
							<input type="password" name="password" maxlength="20" class="txt_input r3px" title="请输入密码"/>
						  </p>
						  <p>
							<label for="verifypass">确认密码：</label>
							<input type="password" maxlength="20" class="txt_input r3px" title="请验证密码"/>
						  </p>
						  <p>
							<label for="email_reg">电子邮箱：</label>
							<input type="text" class="noime txt_input r3px" title="请输入电子邮箱"/>
						  </p>
                          <p>
							<label for="mobi_reg">手机号码：</label>
							<input type="text" class="noime txt_input r3px" title="请输入手机号码"/>
						  </p>
						  <p>
							<label for="email_reg">密保安全码：</label>
							<input type="text" class="noime txt_input r3px" title="请输入密保安全码"/>
						  </p>
						  <p class="label">
						  ...
						  <p class="label agreement">
							<input type="checkbox" checked="checked" name="agreement" id="agreement" class="">
							我已阅读并接受《<a target="_blank" title="《淘富蜜用户协议》" href="#">使用协议</a>》
						  </p>
					  </div>
          ...
          <div class="unlogin_side">
            ...
            <ul class="reg_with">
              ...
              <li class="more_of"><a href="javascript:;" class="more"><i class="icon more"></i><span title="更多合作网站登录">更多合作网站</span></a></li>
            </ul>
